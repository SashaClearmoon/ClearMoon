...
contract TokenContract is Context, IERC20, Ownable {
    ...
    string private _name = "ClearMoon";
    string private _symbol = "CMON";
    
    uint256 private _reflectFee = 0; // Placeholder, set dynamically for buys and sells.
    uint256 private _buyReflectFee = 3;
    uint256 private _sellReflectFee = 10;
    ...
    uint256 private _marketingFee = 0; // Placeholder, set dynamically for buys and sells.
    uint256 private _buyMarketingFee = 1;
    uint256 private _sellMarketingFee = 2;
    uint256 private _previousMarketingFee = _marketingFee;

    uint256 private _marketingRatio = 3;
    uint256 private _liquidityRatio = 3;
    ...
    address payable private _marketingWallet = payable(0x205e8f55c8e9c1A0F60077006cE130100B8a39fe);
    ...
    function setBlacklisted(address account, bool enabled) external onlyOwner() {
    ...
    function setRatios(uint256 marketingRatio, uint256 liquidityRatio) external onlyOwner() {
        _marketingRatio = marketingRatio;
        _liquidityRatio = liquidityRatio;
    }
    
    function setMaxTxAmount(uint256 _amount) external onlyOwner() {
        _maxTxAmount = _amount * 10**_decimalsMul;
    }
...
,        address to,
    ...
    function removeAllFee() private {
        if(_reflectFee == 0 && _liquidityFee == 0 && _marketingFee == 0) return;
